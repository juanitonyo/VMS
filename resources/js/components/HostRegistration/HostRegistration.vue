                            ...
                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                ...
                                <div class="md:col-span-3">
                                    ...
                                    <input type="text" name="email" id="email"
                                        ...
                                        value="" placeholder="example@domain.com" autocomplete="off" />
                                </div>
                                ...
                                <div class="md:col-span-2 relative">
                                    ...
                                    <button type="button" @click.prevent="showHide()" class="absolute right-2 top-[55%]">
                                        <svg v-show="!showPassword" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="md:col-span-3">
                                    ...
                                    <div
                                        ...
                                        <v-select id="gov_id" :options="valid_id" :placeholder="'Valid ID'"
