                                ...
                                <div class="md:col-span-3 relative">
                                    ...
                                    <div
                                        ...
                                        <v-select v-model="form.gov_id" id="gov_id" :options="gov_id"
                                            ...
                                            :class="form.errors.has('gov_id') ? 'text-xs border border-red-700 bg-red-100/25 rounded px-4 mt-1 h-8 w-full' : 'h-8 text-xs border mt-1 rounded px-4 w-full bg-gray-50'">
                                        </v-select>
                                    </div>
                                </div>
