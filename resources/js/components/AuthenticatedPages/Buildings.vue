<template>
                                    ...
                                    <tr v-for="item in data.data" :key="item.id">
                                        ...
                                        <td class="text-center px-3 py-4 text-xs text-gray-900 flex space-x-1.5">
                                            <button :disabled="item.status ? false : true"
                                                ...
                                                :class="[item.status ? 'hover:bg-gray-50' : '', 'border border-gray-900 rounded-md py-1.5 px-3 w-full']">Visitor</button>
                                            <button :disabled="item.status ? false : true"
                                                @click.prevent="isOpen('Host', item)"
                                                :class="[item.status ? 'hover:bg-gray-50' : '', 'border border-gray-900 rounded-md py-1.5 px-3 w-full']">Host</button>
                                        </td>
                                        ...
                                        <td class="relative text-center py-4 pl-3 pr-4 text-xs flex w-full justify-center items-center gap-2"
                                            ...
                                            <a @click.prevent="editBuilding(item)" href="#"
                                                class="flex justify-center text-slate-800 hover:text-blue-400">
            ...
            <form @submit.prevent="editMode ? updateBuilding() : saveBuilding()">
                <div class="relative flex-1 py-2 px-4 sm:px-6 divide-y divide-gray-200 border ">
                    <div class="my-4 grid grid-cols-1">
                        ...
                        <div class="sm:col-span-3 mt-3">
                            <SwitchGroup as="div" class="flex items-center justify-between">
                                ...
                                <Switch v-model="form.health_form"
                                    :class="[form.health_form ? 'bg-blue-800' : 'bg-gray-200', 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2']">
                        ...
                        <div class="sm:col-span-3 mt-2" :class="editMode ? '' : 'hidden'">
                            <SwitchGroup as="div" class="flex items-center justify-between">
                                <span class="flex flex-grow flex-col">
                                    <SwitchLabel as="span" class="text-sm font-medium leading-6 text-gray-900" passive>
                                        Status</SwitchLabel>
                ...
                <div class="flex flex-shrink-0 justify-end px-4 py-4 ">
                    ...
                    <button type="submit"
                        class="ml-4 inline-flex justify-center rounded-md bg-blue-800 hover:bg-blue-800/90 py-2 px-3 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500">{{
                            editMode
                            ? 'Update' : 'Save' }}</button>
                </div>
            </form>
    ...
    <DialogVue :isOpen="pop" :dialogTitle="mode + ' QR | ' + form.building_name" :modalWidth="'max-w-3xl'">
        <template v-slot:dialogBody>
            ...
            <div class="mt-4">
                <button type="button"
                    class="inline-flex w-full justify-center rounded-md bg-blue-800 py-2 px-5 text-sm font-semibold text-white shadow-sm hover:bg-blue-800/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500"
