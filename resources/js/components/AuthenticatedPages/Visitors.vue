                        ...
                        <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-300">
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    <tr v-for="item in data.data" :key="item.id" v-if="(item ?? false) ? (item.visitor.name.toLowerCase().trim() == this.search.toLowerCase().trim() || item.visit_type.name.toLowerCase().trim() == this.search.toLowerCase().trim() || item.building.building_name.toLowerCase().trim() == this.search.toLowerCase().trim()) : false">
