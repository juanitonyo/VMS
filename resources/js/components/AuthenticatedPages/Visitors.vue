    ...
    <SliderVue :setOpen="open" :title="(editMode ? 'View ' : 'Add ') + 'Visitors'"
        ...
        <template v-slot:slider-body>
            ...
            <div class="flex flex-shrink-0 justify-end px-4 py-4 ">
                ...
                <button type="submit"
                    class="ml-4 inline-flex justify-center rounded-md bg-gray-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500">Save</button>
            </div>
        </template>
    </SliderVue>
</template>
