<template>
    <div class="mx-auto max-w-full px-4 sm:px-6 lg:px-8 mt-3">
        <div
            class="p-5 sm:px-6 lg:px-8 bg-white rounded-lg ring-1 ring-slate-900/10"
        >
                            ...
                            <table class="min-w-full divide-y divide-gray-300">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th
                                            scope="col"
                                            class="text-left px-3 py-3.5 text-sm font-semibold text-gray-900"
                                        >
                                            Email
                                        </th>
                                        <th
                                        ...
                                        <th
                                            scope="col"
                                            class="text-center py-3.5 pl-3 pr-4 sm:pr-6"
                                        >
                                            Action
                                        </th>
                                    </tr>
                                ...
                                >
                                    ...
                                    >
                                        <td
                                            class="w-80 py-4 pl-4 pr-3 text-xs font-600 text-gray-900 sm:pl-6"
                                        >
                                            {{ item.name }}
                                        </td>
                                        <td
                                            class="w-72 break-all px-3 py-4 text-xs text-gray-500"
                                        >
                                            {{ item.email }}
                                        </td>
                                        <td
                                        ...
                                        <td
                                            class="whitespace-nowrap px-3 py-4 text-xs text-center text-gray-500"
                                        >
                                            {{
                                        ...
                                        <td
                                            class="w-72 px-3 py-4 text-xs text-gray-500"
                                        >
                                            {{ item.role.title }}
                                        </td>
                                        <td
            ...
            <SliderVue
                :setOpen="open"
                :title="(editMode ? 'Update ' : 'Add ') + 'User'"
                :description="'A list of all the users in your account including their name, title, email and role.'"
            >
                <template v-slot:slider-body>
                    <form
                        @submit.prevent="editMode ? updateUser() : saveUser()"
                    >
                        <div
                            class="relative flex-1 py-2 px-4 sm:px-6 divide-y divide-gray-200 border"
                        >
                            <div class="my-4 grid grid-cols-1">
                                ...
                                <div class="sm:col-span-3 mt-3 text-sm">
                                    ...
                                    <v-select
                                        ...
                                        placeholder="search"
                                        :class="
                                            form.errors.has('building')
                                                ? 'bg-red-50  border-red-500 text-red-900 placeholder-red-700'
                                                : ''
                                        "
                                    ></v-select>
                                    <span
                                        v-show="form.errors.has('building')"
                                        class="text-xs/2 text-red-600 dark:text-red-500"
                                        >{{
                                    }}</span>
                                </div>
