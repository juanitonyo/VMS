            ...
            <div class="sm:flex sm:items-center">
                ...
                <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                    <button @click.prevent="setOpen" type="button"
                        class="block rounded-md bg-blue-800 py-2 px-3 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-800/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">
                        Add Role
                    </button>
                </div>
            </div>
                                ...
                                <table class="min-w-full divide-y divide-gray-300">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th scope="col"
                                                class="text-center py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-900 sm:pl-6">
                                                View
                                            </th>
                                            <th scope="col"
                                                class="text-center py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-900 sm:pl-6">
                                    ...
                                    <tbody v-for="item in modules" :key="item.id" class="divide-y divide-gray-200 bg-white">
                                        <tr class="hover:bg-gray-50">
                                            <td class="w-72 break-all px-6 py-4 text-xs text-gray-500">
                                                {{ item.name }}
                                            </td>
