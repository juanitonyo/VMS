            ...
            <nav class="mt-5 h-full flex-shrink-0 divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
              <div class="space-y-1 px-2">
                <a v-for="item in navigation" :key="item.name" :href="item.href"
                  :class="[item.current ? 'bg-cyan-800 text-white' : 'text-cyan-100 hover:bg-cyan-600 hover:text-white', 'group flex items-center rounded-md px-2 py-2 text-base font-medium']"
...
const cards = [
  { name: 'Total Visitors', href: '#', icon: ScaleIcon, amount: '150' },
  { name: 'Total Checked In', href: '#', icon: ScaleIcon, amount: '140' },
  { name: 'Total Checked Out', href: '#', icon: ScaleIcon, amount: '130' },
