<template>
    <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex gap-1">
            <button @click.prevent="setOpen" type="button"
                ...
                SMS</button>
            <button class="hover:bg-blue-800/90 bg-blue-800 p-2 rounded-md">
    ...
    <SliderVue :setOpen="open" :title="(editMode ? 'Update ' : 'Add ') + 'SMS Template'"
        :description="'A catalog of all SMS template maintenance entries.'">
                        ...
                        <div class="sm:col-span-3 mt-3">
                            <div class="flex justify-between">
                                ...
                                <span v-show="form.errors.has('message')"
                                    class="text-[10px] text-red-600 dark:text-red-500 mt-1">{{ form.errors.get('message')
                                    }}</span>
                            </div>
...
export default {
    ...
    methods: {
        ...
        async getData(page = 1) {
            await axios.get('/api/sms-template?page=' + page).then((data) => {
