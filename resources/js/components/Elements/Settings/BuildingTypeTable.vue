        ...
        <template v-slot:slider-body>
            <form @submit.prevent="editMode ? updateBuilding() : saveBuilding()">
                <div class="relative flex-1 py-2 px-4 sm:px-6 divide-y divide-gray-200 border ">
                    <div class="my-4 grid grid-cols-1">
                        ...
                        <div class="sm:col-span-3 mt-3">
                            ...
                            <div class="mt-2">
                                <input v-model="form.description" type="text" name="building-name" id="building-name"
                                    autocomplete="given-name"
                                    class="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 outline-none sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                ...
                <div class="flex flex-shrink-0 justify-end px-4 py-4 ">
                    <button type="button" :disabled="form.busy"
