<template>
    <div class="sm:flex sm:items-center">
            ...
            <p class="mt-2 text-sm text-gray-700">A pre-designed format for creating consistent and professional email messages with predefined content and structure.</p>
            </div>
