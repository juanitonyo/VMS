        ...
        <div class="flex flex-col items-center justify-center space-y-20">
            ...
            <div class="flex flex-col items-center justify-center">
                ...
                <a :href="'/login-google?building-id='+id" type="button"
                    class="text-white bg-red-500 hover:bg-red-500/90 focus:ring-2 focus:outline-none focus:ring-red-500/50 font-medium rounded-lg text-xs py-2.5 mt-3 text-center flex items-center justify-center dark:focus:ring-[#4285F4]/55 w-[300px]">
                ...
                <a :href="'/login-facebook?building-id='+id" type="button"
                    class="text-white bg-blue-500 hover:bg-blue-500/90 focus:ring-2 focus:outline-none focus:ring-blue-500/50 font-medium rounded-lg text-xs py-2.5 mt-3 text-center flex items-center justify-center dark:focus:ring-[#4285F4]/55 w-[300px]">
                    <svg class="w-4 h-4 mr-2 -ml-1" aria-hidden="true" focusable="false" data-prefix="fab"
