<template>
    <div class="flex flex-col items-center justify-center">
        ...
        <div class="flex flex-col items-center justify-center absolute top-64">
            ...
            <a :href="'/visitor-registration/checkin/' + this.id" class="text-white border bg-blue-700 hover:bg-blue-600 focus:ring-2 focus:outline-none focus:ring-blue-500/50 font-medium rounded-lg text-xs px-5 py-2.5 text-center inline-flex items-center justify-center dark:focus:ring-[#4285F4]/55 mr-2 mt-3 w-[330px] cursor-pointer">
                Submit
            </a>
        </div>
