<template>
    <div class="flex justify-center items-center min-h-screen min-w-screen bg-background bg-cover">
        <div
            class="flex flex-col items-center justify-center h-screen w-full sm:w-fit gap-y-8 sm:shadow-lg shadow-none sm:px-5 px-0 sm:py-10 py-0 sm:rounded-lg rounded-none bg-white">
